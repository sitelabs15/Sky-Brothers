...
export const cleaningFrequencies: CleaningFrequencyItem[] = [
  {
    ...
    idealFor: "Colchones matrimoniales, individuales, queen y king size",
    reason: "Previene alergias respiratorias, erradica ácaros y elimina manchas de sudor y humedad de la costa.",
    message: "Hola Sky Brothers, me gustaría cotizar la desinfección y lavado de mis colchones.",
  },
  {
    id: "sofas",
    item: "Sofás / Salas",
    frequency: "Cada 6 meses",
    idealFor: "Salas principales, sillones, esquineros y sofás familiares",
    reason: "Elimina sudor corporal, polvo acumulado, células muertas y ácaros antes de que dañen el tejido.",
    message: "Hola Sky Brothers, me gustaría cotizar la limpieza de mi sofá / sala.",
  },
  {
    id: "alfombras",
    item: "Tapetes / Alfombras",
    frequency: "De 10 a 12 meses",
    idealFor: "Tapetes decorativos, de sala, recámaras y alfombras fijas",
    reason: "Extrae suciedad atrapada en las fibras profundas y evita malos olores por humedad y acumulación.",
    message: "Hola Sky Brothers, me gustaría cotizar la limpieza de tapetes / alfombras.",
  },
  {
    id: "autos",
    item: "Interiores de autos",
    frequency: "Cada 6 meses",
    idealFor: "Asientos particulares, camionetas, respaldos y alfombrillas",
    reason: "Remueve arena de playa, manchas de bebidas, sudor y bacterias por el calor.",
    message: "Hola Sky Brothers, me gustaría cotizar el lavado de interiores de mi auto.",
  },
  {
    id: "almohadas",
    item: "Almohadas",
    frequency: "De 3 a 4 meses",
    idealFor: "Almohadas de descanso, cojines decorativos y respaldos",
    reason: "Sanitización profunda para eliminar ácaros faciales, sudor nocturno, saliva y bacterias acumuladas.",
    message: "Hola Sky Brothers, me gustaría cotizar la limpieza y desinfección de almohadas.",
  },
  {
    id: "camastros",
    item: "Camastros",
    frequency: "Cada 6 meses",
    idealFor: "Camastros de alberca, terraza, jardín y exteriores",
    reason: "Elimina residuos de bloqueador solar, cloro, sudor, moho y manchas provocadas por la intemperie.",
    message: "Hola Sky Brothers, me gustaría cotizar la limpieza de camastros.",
  },
  {
    id: "sillas",
    item: "Sillas",
    frequency: "Cada 6 meses",
    idealFor: "Sillas de comedor, oficina y sillas tapizadas",
