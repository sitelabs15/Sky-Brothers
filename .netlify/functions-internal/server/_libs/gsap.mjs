...
var Timeline = /*#__PURE__*/ (function (_Animation) {
  ...
  _proto2.tweenFromTo = function tweenFromTo(fromPosition, toPosition, vars) {
    return this.tweenTo(
      toPosition,
      _setDefaults$1({ startAt: { time: _parsePosition$1(this, fromPosition) } }, vars),
    );
  };
    ...
    while (i--) {
      ...
      if (!pt) {
        ...
        return skipRecursion
          ? _warn(property + " not eligible for reset. Try splitting into individual properties")
          : 1;
      }
      ptCache.push(pt);
    }
  ...
  _proto3.render = function render(totalTime, suppressEvents, force) {
    ...
    if (!dur) _renderZeroDurationTween(this, totalTime, suppressEvents, force);
      ...
      if (this._rEase) {
        ...
        this.ratio = ratio =
          this._invRatio + this._invScale * this._invEase((time - this._invTime) * this._invRecip);
...
var _removeProperty = function _removeProperty(target, property) {
  if (property) {
    ...
    if (style.removeProperty) {
      ...
      style.removeProperty(
        first2Chars === "--" ? property : property.replace(_capsExp$1, "-$1").toLowerCase(),
      );
...
var _addPxTranslate = function _addPxTranslate(target, start, value) {
  ...
  return (
    _round$1(parseFloat(start) + parseFloat(_convertToUnit(target, "x", value + "px", unit))) + unit
  );
};
...
var _addRotationalPropTween = function _addRotationalPropTween(
  ...
  var cap = 360,
    ...
    change =
      parseFloat(endValue) * (isString && ~endValue.indexOf("rad") ? _RAD2DEG : 1) - startNum,
  ...
  _proto.init = function init(vars, animation) {
    ...
    if (snap) {
      ...
      "scrollBehavior" in _body.style &&
        gsap.set(isViewport ? [_body, _docEl] : scroller, { scrollBehavior: "auto" });
              ...
              tweenTo(
                endScroll,
                {
                  ...
                  onInterrupt: function onInterrupt() {
                    return (
                      snapDelayedCall.restart(true) && _onInterrupt && _callback(self, _onInterrupt)
                    );
                  },
                  onComplete: function onComplete() {
                    self.update();
